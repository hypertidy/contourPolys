...
image(volcano, col = NA); lapply(cl, polygon)
```
...
Further, with all the fragments the coordinates can be reprojected in a way
that various R image plotters cannot do. 
